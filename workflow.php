        ...
        <div class="section">
            ...
            <div class="step">
                ...
                <div>
                    ...
                    <code>http://agondigital.com/{shortcode}?pub={publisher_id}</code>
...
WHERE DATE(created_at) <= :report_date;</pre>
        ...
        <div class="section">
            ...
            <div class="highlight">
                ...
                <p>All shortened URLs use the fixed domain <strong>agondigital.com</strong> with the format: <code>http://agondigital.com/{shortcode}</code></p>
            </div>
            ...
            <div class="highlight">
                ...
                <ol>
                    <li>User clicks tracking link: <code>http://agondigital.com/{shortcode}?pub={publisher_id}</code></li>
