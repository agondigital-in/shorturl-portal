...
Publisher का URL: `https://tracking.agondigital.in/c/CAMPRCLXWI6M4CFG`
...
### Method 1:
1. Campaign tracking page खोलें: `http://localhost/shorturl/super_admin/campaign_tracking_stats.php?id=33`
2. "View Daily Clicks" button पर click करें

### Method 2:
Direct link: `http://localhost/shorturl/super_admin/publisher_daily_clicks.php?id=33`
