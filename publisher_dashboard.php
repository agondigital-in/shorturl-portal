                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <code class="small">https://tracking.agondigital.in/c/<?php echo htmlspecialchars($campaign['short_code']); ?></code>
                                                    <button class="btn btn-outline-primary btn-sm ms-2 copy-btn" onclick="copyToClipboard('https://tracking.agondigital.in/c/<?php echo htmlspecialchars($campaign['short_code']); ?>', this)">
