...
When a user clicks on a publisher's short URL (e.g., `https://tracking.agondigital.in/c/CAMPRCLXWI6M4CFG`):
...
- Campaign Tracking Stats page: `http://localhost/shorturl/super_admin/campaign_tracking_stats.php?id=33`
- Click the "View Daily Clicks" button
- Or directly: `http://localhost/shorturl/super_admin/publisher_daily_clicks.php?id=33`
...
1. Publisher gets unique URL: `https://tracking.agondigital.in/c/CAMPRCLXWI6M4CFG`
