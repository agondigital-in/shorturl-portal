...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0"><i class="fas fa-user-shield me-2"></i>All Admin Users</h5>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php foreach ($admins as $admin): ?>
                            <tr>
                                <td><span class="badge badge-soft-primary">#<?php echo htmlspecialchars($admin['id']); ?></span></td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <span class="badge badge-soft-primary"><i class="fas fa-user me-1"></i>Admin</span>
                                    <?php endif; ?>
                                </td>
